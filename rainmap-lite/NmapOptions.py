#!/usr/bin/env python
# Nmap command line parser from Zenmap Core: 
# https://github.com/nmap/nmap/blob/master/zenmap/zenmapCore/NmapOptions.py
#
#################################################################
# Zenmap is distributed under the same license terms as Nmap. See 
# https://nmap.org/man/man-legal.html for more information.
################################################################ 
#
